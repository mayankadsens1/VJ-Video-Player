...
# Bot Session Name
SESSION = environ.get('SESSION', 'WarriorUnitsBot')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002807877721'))
...
LINK_URL = environ.get("LINK_URL", "https://wuplayer.blogspot.com/p/player.html")
